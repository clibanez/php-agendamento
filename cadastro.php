...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        debug_log("Cliente adicionado com sucesso!");
        ...
        debug_log("Erro ao adicionar cliente: " . $e->getMessage());
        $erro = $e->getMessage();
    }
}
...
<head>
    ...
    <title>Cadastro de Cliente - <?php echo htmlspecialchars($empresa['nome']); ?></title>
